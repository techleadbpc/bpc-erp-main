...
const TransferChallanPDFRefactored = ({ transfer }) => {
  ...
  const sections = [
    ...
    {
      children: (
        <View style={{ borderWidth: 1, borderColor: "#00", padding: 8, marginBottom: 10, backgroundColor: "#f0f0f0" }}>
...
export default TransferChallanPDFRefactored;
